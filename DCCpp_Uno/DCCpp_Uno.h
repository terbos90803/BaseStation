...
/////////////////////////////////////////////////////////////////////////////////////
  ...
  #define CURRENT_MONITOR_SAMPLES_PER_AMP_ARDUINO 300

  #define CURRENT_MONITOR_MAX_AMPS_MAIN 1.8
  #define CURRENT_MONITOR_MAX_AMPS_PROG 1.0

  #define CURRENT_MONITOR_MAX_SAMPLES_MAIN (CURRENT_MONITOR_SAMPLES_PER_AMP_ARDUINO * CURRENT_MONITOR_MAX_AMPS_MAIN)
  #define CURRENT_MONITOR_MAX_SAMPLES_PROG (CURRENT_MONITOR_SAMPLES_PER_AMP_ARDUINO * CURRENT_MONITOR_MAX_AMPS_PROG)
  ...
  #define CURRENT_MONITOR_SAMPLES_PER_AMP_POLALU 300

  #define CURRENT_MONITOR_MAX_AMPS_MAIN 3.8
  #define CURRENT_MONITOR_MAX_AMPS_PROG 1.0

  #define CURRENT_MONITOR_MAX_SAMPLES_MAIN (CURRENT_MONITOR_SAMPLES_PER_AMP_POLALU * CURRENT_MONITOR_MAX_AMPS_MAIN)
  #define CURRENT_MONITOR_MAX_SAMPLES_PROG (CURRENT_MONITOR_SAMPLES_PER_AMP_POLALU * CURRENT_MONITOR_MAX_AMPS_PROG)
  ...
  #define MOTOR_SHIELD_NAME "ARDUINO & CYTRON MOTOR SHIELD"

  #define SIGNAL_ENABLE_PIN_MAIN 3
  #define SIGNAL_ENABLE_PIN_PROG 11

  #define CURRENT_MONITOR_PIN_MAIN A2
  #define CURRENT_MONITOR_PIN_PROG A1

  #define CURRENT_MONITOR_SAMPLES_PER_AMP_CYTRON 5
  #define CURRENT_MONITOR_SAMPLES_PER_AMP_ARDUINO 300

  #define CURRENT_MONITOR_MAX_AMPS_MAIN 4.8
  #define CURRENT_MONITOR_MAX_AMPS_PROG 1.0

  #define CURRENT_MONITOR_MAX_SAMPLES_MAIN (CURRENT_MONITOR_SAMPLES_PER_AMP_CYTRON * CURRENT_MONITOR_MAX_AMPS_MAIN)
  #define CURRENT_MONITOR_MAX_SAMPLES_PROG (CURRENT_MONITOR_SAMPLES_PER_AMP_ARDUINO * CURRENT_MONITOR_MAX_AMPS_PROG)
